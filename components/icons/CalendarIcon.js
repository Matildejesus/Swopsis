...
function CalendarIcon({ calendarDates, itemId, owner }) {
    const navigation = useNavigation();

    return (
        <TouchableOpacity 
            onPress={() => navigation.navigate("Calendar", { dates: calendarDates, itemId, owner })} 
        >
            <View style={styles.container}>
                ...
                {!calendarDates && <Text style={styles.text}>Calendar</Text>}
            </View>
        </TouchableOpacity>
    );
}
